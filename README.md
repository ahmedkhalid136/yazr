...
1. **Workspace template**
   ...
   The user will see a table containing each field. Eac field can be modified.
   The title and the industry can be modified.
...
4. **Chat benchmark.**
   ...
   Main insights from each chat should become part of the knowledge base.
